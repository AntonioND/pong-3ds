...
This is far from complete. Actually, it was just a test to see if I could manage to setup a correct perspective for stereoscopic 3D.
...
The engine renders each top screen in a separate core when working in 3D mode.
